...
fig_match = figure;
I1 = rgb2gray(I);
points1 = detectSURFFeatures(I1); % Strat 2
[f1, vpts1] = extractFeatures(I1, points1, 'Method','SURF'); %Strat 2
for im_num = 2:length(files)
    fname = fullfile(img_path, files(im_num).name);
    I = imread(fname);
    I2 = rgb2gray(I);
    %points1 = detectSURFFeatures(I1); % Strat 1
    points2 = detectSURFFeatures(I2);
    %[f1, vpts1] = extractFeatures(I1, points1, 'Method','SURF'); % Strat 1
    ...
    if n >= 4
        ...
        if num_max >= 4
            ...
            Hwi = Hbest * Hw0 ;% Strat 2
            %Hwi = Hbest * Hwi; %Strat 1 
            P = H2P(Hwi,K);
